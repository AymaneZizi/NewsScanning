...
def connect_to_database(database):
	...
	c.execute("SELECT date, Url, title, summary, date FROM RSSEntries where date >= date('now', '-30 day');")
	get_all = c.fetchall()
...
if __name__ == '__main__':
	news_articles = connect_to_database(database='C:/_LOCALData/imap/rss.sqlite')
